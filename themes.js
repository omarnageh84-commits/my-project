...
function applyTheme(name){
  ...
  try{ if(window.parent && window.parent.applyTheme && window.parent!==window) window.parent.applyTheme(name); }catch(e){}
...
document.addEventListener('DOMContentLoaded',()=>{ applyTheme(localStorage.getItem('omar_theme')||'green'); });ض
